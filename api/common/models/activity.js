          ...
          let location = await app.models.Location.findOrCreate(
            ...
            },
            {
              ...
              name: raw.properties.location_name
                ? raw.properties.location_name
                : raw.properties.source,
            },
          );

          if (location != null) {
            const name = raw.properties.label
              ? raw.properties.label
              : raw.properties.name;
            const caddr = raw.properties.location_address
              ? raw.properties.location_address +
                ' ' +
                raw.properties.location_city
              : raw.properties.source;
            let activity = await Activity.findOrCreate(
              {
                where: { name: name },
